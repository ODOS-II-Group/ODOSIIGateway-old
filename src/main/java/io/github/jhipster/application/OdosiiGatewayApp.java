...
@EnableZuulProxy
public class OdosiiGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(OdosiiGatewayApp.class);

    private final Environment env;

    public OdosiiGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes ODOSIIGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(OdosiiGatewayApp.class);
